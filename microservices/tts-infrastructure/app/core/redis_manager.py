...
class RedisKeys:
    # Redis key prefixes
    JOB_PREFIX = "stitch_job"
    JOB_QUEUE = "stitch_queue"
    JOB_PROCESSING = "stitch_processing"
    METADATA_CACHE = "audio_metadata"
...
class RedisManager(RedisKeys):
    ...
    async def connect(self):
        ...
        self._connection_pool = redis.ConnectionPool.from_url(redis_url, encoding="utf-8", decode_responses=True, max_connections=10)
